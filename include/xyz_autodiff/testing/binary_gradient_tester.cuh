...
#define TEST_BINARY_GRADIENT(LogicType, Input1Dim, Input2Dim, OutputDim, TestName) \
    TEST(GradientTest, TestName) { \
        xyz_autodiff::testing::BinaryGradientTester<LogicType, Input1Dim, Input2Dim, OutputDim>::test(#TestName); \
    }

#define TEST_BINARY_GRADIENT_CUSTOM(LogicType, Input1Dim, Input2Dim, OutputDim, TestName, NumTests, Tolerance, Delta) \
    TEST(GradientTest, TestName) { \
        xyz_autodiff::testing::BinaryGradientTester<LogicType, Input1Dim, Input2Dim, OutputDim>::test_custom(#TestName, NumTests, Tolerance, Delta); \
    }
