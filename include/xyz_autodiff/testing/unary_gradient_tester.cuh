...
#define TEST_UNARY_GRADIENT(LogicType, InputDim, OutputDim, TestName) \
    TEST(GradientTest, TestName) { \
        xyz_autodiff::testing::UnaryGradientTester<LogicType, InputDim, OutputDim>::test(#TestName); \
    }

#define TEST_UNARY_GRADIENT_CUSTOM(LogicType, InputDim, OutputDim, TestName, NumTests, Tolerance, Delta) \
    TEST(GradientTest, TestName) { \
        xyz_autodiff::testing::UnaryGradientTester<LogicType, InputDim, OutputDim>::test_custom(#TestName, NumTests, Tolerance, Delta); \
    }
