...
concept Operation = requires(T op, Output output, Inputs... inputs) {
...
template <typename T, typename Output, typename... Inputs>
concept DifferentiableOperation = Operation<T, Output, Inputs...> && 
...
template <typename T, typename Output, typename... Inputs>
concept TestableOperation = DifferentiableOperation<T, Output, Inputs...> && 
    requires(T op, Output output, Inputs... inputs) {
